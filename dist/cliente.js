...
var Cliente = exports.Cliente = /*#__PURE__*/function () {
  ...
  _createClass(Cliente, [{
    ...
    value: function calcularImpuesto() {
      var calculo = (_classPrivateFieldGet(_impuesto, this).montoBrutoAnual - _classPrivateFieldGet(_impuesto, this).deducciones) * .21;
      return "El c\xE1lculo del impuesto es: ".concat(calculo);
    }
  }]);
  return Cliente;
}();